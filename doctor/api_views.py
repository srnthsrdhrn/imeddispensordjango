...
from dispenser.models import DispenseLog, Chamber, Device, Load
...
class PrescriptionAPI(APIView):
    def get(self, request):
        ...
        for composition in compositions:
            ...
            quota = required_qty - dispensed_qty
            medicine_id = None
            medicine = None
            multiplier = 100
            is_available = False
            if loads.exists():
                ...
                for dosage in dosages:
                    dosage_medicine_id = dosage['load_data__medicine']
        ...
        for load in loads:
            ...
            for load_data in load.load_data.all():
                dict = {}
